...
let Comparison1 = 44 > 54; // false
let Comparison2 = 44 < 54; // true
let Comparison3 = 44 >= 54;// false
let Comparison4 = 44 <= 54;// true
...
let myCountryName = "Pakistan";


let homeLand = myCountryName;
homeLand = "England";
